...
model <- lmer(score ~ steps + ns(week, df=3) + (1 | id), data = pregnancy_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)

model <- lmer(score ~ steps + ns(week, df=3) + age_category + education + previous_children + 
...
model <- lmer(score ~ steps_lag1 + ns(week, df=3) + (1 | id), data = pregnancy_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)


model <- lmer(score ~ steps_lag1 + ns(week, df=3) + age_category + education + previous_children + 
                epds_category + bmi_bl2 + gt_weight_gain + (1 | id), data = pregnancy_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)
...
model <- lmer(score ~ steps_mean3 + ns(week, df=3) + (1 | id), data = pregnancy_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)

model <- lmer(score ~ steps_mean3 + ns(week, df=3) + age_category + education + previous_children + 
                epds_category + bmi_bl2 + gt_weight_gain + (1 | id), data = pregnancy_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)
...
model <- lmer(score ~ steps + ns(week, df=3) + (1 | id), data = postpartum_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)
...
model <- lmer(score ~ steps_lag1 + ns(week, df=3) + (1 | id), data = postpartum_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)
...
model <- lmer(score ~ steps_mean3 + ns(week, df=3) + (1 | id), data = postpartum_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)
...
model <- lmer(score ~ average_met + ns(week, df=3) + (1 | id), data = pregnancy_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)

model <- lmer(score ~ average_met + ns(week, df=3) + age_category + education + previous_children + 
                epds_category + bmi_bl2 + gt_weight_gain + (1 | id), data = pregnancy_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)
...
model <- lmer(score ~ average_met_lag1 + ns(week, df=3) + (1 | id), data = pregnancy_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)
...
model <- lmer(score ~ average_met_mean3 + ns(week, df=3) + (1 | id), data = pregnancy_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)

model <- lmer(score ~ average_met_mean3 + ns(week, df=3) + age_category + education + previous_children + 
                epds_category + bmi_bl2 + gt_weight_gain + (1 | id), data = pregnancy_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)
...
model <- lmer(score ~ average_met + ns(week, df=3) + (1 | id), data = postpartum_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)
...
model <- lmer(score ~ average_met_lag1 + ns(week, df=3) + (1 | id), data = postpartum_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)
...
model <- lmer(score ~ average_met_mean3 + ns(week, df=3) + (1 | id), data = postpartum_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)
...
model <- lmer(score ~ met_min_high + ns(week, df=3) + (1 | id), data = pregnancy_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)

model <- lmer(score ~ met_min_high + ns(week, df=3) + age_category + education + previous_children + 
                epds_category + bmi_bl2 + gt_weight_gain + (1 | id), data = pregnancy_sync, REML=FALSE)
...
model <- lmer(score ~ met_min_high_lag1 + ns(week, df=3) + (1 | id), data = pregnancy_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)


model <- lmer(score ~ met_min_high_lag1 + ns(week, df=3) + age_category + education + previous_children + 
                epds_category + bmi_bl2 + gt_weight_gain + (1 | id), data = pregnancy_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)
...
model <- lmer(score ~ met_min_high_mean3 + ns(week, df=3) + (1 | id), data = pregnancy_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)

model <- lmer(score ~ met_min_high_mean3 + ns(week, df=3) + age_category + education + previous_children + 
                epds_category + bmi_bl2 + gt_weight_gain + (1 | id), data = pregnancy_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)
...
model <- lmer(score ~ met_min_high + ns(week, df=3) + (1 | id), data = postpartum_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)

# model <- lmer(score ~ met_min_high + ns(week, df=3) + (1 + ns(week, df=3) | id), data = postpartum_sync, REML=FALSE)
# summary(model)
...
model <- lmer(score ~ met_min_high_lag1 + ns(week, df=3) + (1 | id), data = postpartum_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)
...
model <- lmer(score ~ met_min_high_mean3 + ns(week, df=3) + (1 | id), data = postpartum_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)
...
model <- lmer(score ~ met_min_medium + ns(week, df=3) + (1 | id), data = pregnancy_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)


model <- lmer(score ~ met_min_medium + ns(week, df=3) + age_category + education + previous_children + 
                epds_category + bmi_bl2 + gt_weight_gain + (1 | id), data = pregnancy_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)
...
model <- lmer(score ~ met_min_medium_lag1 + ns(week, df=3) + (1 | id), data = pregnancy_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)

model <- lmer(score ~ met_min_medium_lag1 + ns(week, df=3) + age_category + education + previous_children + 
                epds_category + bmi_bl2 + gt_weight_gain + (1 | id), data = pregnancy_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)
...
model <- lmer(score ~ met_min_medium_mean3 + ns(week, df=3) + (1 | id), data = pregnancy_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)

model <- lmer(score ~ met_min_medium_mean3 + ns(week, df=3) + age_category + education + previous_children + 
                epds_category + bmi_bl2 + gt_weight_gain + (1 | id), data = pregnancy_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)
...
model <- lmer(score ~ met_min_medium + ns(week, df=3) + (1 | id), data = postpartum_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)

# model <- lmer(score ~ steps + ns(week, df=3) + (1 + ns(week, df=3) | id), data = postpartum_sync, REML=FALSE)
# summary(model)
...
model <- lmer(score ~ met_min_medium_lag1 + ns(week, df=3) + (1 | id), data = postpartum_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)
...
model <- lmer(score ~ met_min_medium_mean3 + ns(week, df=3) + (1 | id), data = postpartum_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)
...
model <- lmer(score ~ met_min_low + ns(week, df=3) + (1 | id), data = pregnancy_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)


model <- lmer(score ~ met_min_low + ns(week, df=3) + age_category + education + previous_children + 
                epds_category + bmi_bl2 + gt_weight_gain + (1 | id), data = pregnancy_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)
...
model <- lmer(score ~ met_min_low_lag1 + ns(week, df=3) + (1 | id), data = pregnancy_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)

model <- lmer(score ~ met_min_low_lag1 + ns(week, df=3) + age_category + education + previous_children + 
                epds_category + bmi_bl2 + gt_weight_gain + (1 | id), data = pregnancy_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)
...
model <- lmer(score ~ met_min_low_mean3 + ns(week, df=3) + (1 | id), data = pregnancy_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)

model <- lmer(score ~ met_min_low_mean3 + ns(week, df=3) + age_category + education + previous_children + 
                epds_category + bmi_bl2 + gt_weight_gain + (1 | id), data = pregnancy_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)
...
model <- lmer(score ~ met_min_low + ns(week, df=3) + (1 | id), data = postpartum_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)
...
model <- lmer(score ~ met_min_low_lag1 + ns(week, df=3) + (1 | id), data = postpartum_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)
...
model <- lmer(score ~ met_min_low_mean3 + ns(week, df=3) + (1 | id), data = postpartum_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)
...
model <- lmer(score ~ met_min_inactive + ns(week, df=3) + (1 | id), data = pregnancy_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)


model <- lmer(score ~ met_min_inactive + ns(week, df=3) + age_category + education + previous_children + 
                epds_category + bmi_bl2 + gt_weight_gain + (1 | id), data = pregnancy_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)
...
model <- lmer(score ~ met_min_inactive_lag1 + ns(week, df=3) + (1 | id), data = pregnancy_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)

model <- lmer(score ~ met_min_inactive_lag1 + ns(week, df=3) + age_category + education + previous_children + 
                epds_category + bmi_bl2 + gt_weight_gain + (1 | id), data = pregnancy_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)
...
model <- lmer(score ~ met_min_inactive_mean3 + ns(week, df=3) + (1 | id), data = pregnancy_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)

model <- lmer(score ~ met_min_inactive_mean3 + ns(week, df=3) + age_category + education + previous_children + 
                epds_category + bmi_bl2 + gt_weight_gain + (1 | id), data = pregnancy_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)
...
model <- lmer(score ~ met_min_inactive + ns(week, df=3) + (1 | id), data = postpartum_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)
...
model <- lmer(score ~ met_min_inactive_lag1 + ns(week, df=3) + (1 | id), data = postpartum_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)
...
model <- lmer(score ~ met_min_inactive_mean3 + ns(week, df=3) + (1 | id), data = postpartum_sync, REML=FALSE)
summary(model)
AIC(model)
BIC(model)
